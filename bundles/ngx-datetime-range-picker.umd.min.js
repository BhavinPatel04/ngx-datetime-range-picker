!(function(t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(
        (t["ngx-datetime-range-picker"] = {}),
        t.ng.forms,
        t.ng.material,
        t.ng.platformBrowser,
        t.ng.platformBrowser.animations,
        t.ng.core
      );
})(this, function(t, e, a, o, r, n) {
  "use strict";
  var i,
    l,
    m = (function() {
      ...
      return (
        (t.prototype.transform = function(t, e) {
          return void 0 === e && (e = null), Object.keys(t);
        }),
        (t.decorators = [{ type: n.Pipe, args: [{ name: "ObjNgFor", pure: !1 }] }]),
        t
      );
    })(),
    d = require("moment"),
    ...
    b = {
      ...
      CONSTANT: {
        ...
        EU_TZ_CODE: f,
        TZ_CODES: [s, f],
        OFFSETS: ((i = {}), (i[s] = { SO: -7, WO: -8 }), (i[f] = { SO: 1, WO: 0 }), i),
        TZ_NAMES: ((l = {}), (l[c] = "America/Phoenix"), (l[s] = "America/Los_Angeles"), (l[f] = "Europe/Berlin"), l)
      }
    },
    p = require("moment"),
    g = require("lodash"),
    u = b.DEFAULT.TYPE,
    h = b.DEFAULT.INPUT_CLASS,
    x = b.DEFAULT.DATE_FROMAT,
    v = b.DEFAULT.TIME_FORMAT,
    k = b.DEFAULT.START_DATE,
    w = b.DEFAULT.END_DATE,
    y = b.DEFAULT.MIN_DATE,
    D = b.DEFAULT.MAX_DATE,
    T = b.DEFAULT.START_TIME,
    z = b.DEFAULT.END_TIME,
    N = b.DEFAULT.MODEL_KEYS,
    M = b.CONSTANT.MONTHS_AVAILABLE,
    R = b.DEFAULT.TZ_CODE,
    L = b.CONSTANT.EU_TZ_CODE,
    A = b.CONSTANT.TZ_NAMES,
    O = (function() {
      function t() {}
      return (
        (t.prototype.getNotAvailableText = function() {
          return "N/A";
        }),
        (t.prototype.getDefaultAriaLabelOptions = function() {
          return { inputField: "Date Range Input Field" };
        }),
        (t.prototype.getDefaultOptions = function() {
          return { dateArray: [], startDate: k, endDate: w, minDate: y, maxDate: D, startTime: T, endTime: z };
        }),
        ...
        (t.prototype.formatDateToDefaultFormat = function(t, e) {
          void 0 === e && (e = x);
          var a = null;
          return (
            t &&
        ...
        (t.prototype.formatTimeToDefaultFormat = function(t) {
          var e = null;
          return (
            t &&
              (-1 < t.indexOf(":")
                ? (e = -1 < t.indexOf("AM") || -1 < t.indexOf("PM") ? p(t, "h:mm A").format(v) : t)
                : console.warn(
        ...
        (t.prototype.getFrequencyColumnHeader = function(t) {
          return (function() {
            switch (t) {
              case "daily":
                return "W#";
        ...
        (t.prototype.getCalendarRowNumberText = function(t, e) {
          return (function() {
            switch (t) {
              case "daily":
                return "W" + e;
        ...
        (t.prototype.createDefaultRanges = function(t) {
          var e = {},
            a = t.type,
            o = g.cloneDeep(t.maxDate),
            r = this.formatDateToDefaultFormat(o, x);
          return (
            "daily" == a
              ? ((e["Last 7 Days"] = {
                  startDate: p(r, x)
            ...
            (e["Custom Range"] = { startDate: null, endDate: null }),
            e
          );
        }),
        (t.prototype.getSanitizedDateArray = function(t) {
          var o = [],
            r = t.type,
            e = t.dateArray,
            n = t.inputDateFormat;
          return (
            g.forEach(e, function(t) {
              if (t) {
                var e = null;
                isNaN(Number(t)) && (e = n || p(t)._f),
                  n != p(t)._f &&
                    console.warn(
                      "M1 Date Range Picker: Provided inputDateFormat != Date Format in dateArray. Converted dates might not be as expected"
                    );
                var a = e ? p(t, e).format(e) : p(t).valueOf();
                "weekly" == r
                  ? (a = e
                      ? p(t, e)
                          .endOf("week")
        ...
        (t.prototype.getNumberOfWeeks = function(t) {
          var e = null;
          if (t) {
            var a = p(t, x)
                .startOf("month")
        ...
        (t.prototype.getYearlyWeekCount = function(t, e) {
          var a = null;
          if (t) {
            var o = p(t, "YYYY")
                .startOf("year")
              ...
              i = p(o, x)
                .endOf("week")
                .format(x),
              l = this.getWeekNumber(i);
            a = this.getWeekNumber(n) - l + 1;
          }
          return a;
        }),
        (t.prototype.getMonthsAvailable = function(t, e, a) {
          var o = [];
          if (t && e && a) {
            var r = p(t, x).valueOf(),
              n = p(e, x).valueOf(),
            ...
            r < i && (r = i), l < n && (n = l);
            for (
              var m = p(r).month(), d = p(n).diff(p(r), "months"), c = d < M.length ? d : M.length, s = 0;
              s <= c;
              s++
            )
              m >= M.length ? o.push(M[m - M.length]) : o.push(M[m]), m++;
          }
          return o;
        }),
        (t.prototype.getYearsAvailable = function(t) {
          var e = t ? t.minDate : "",
            a = t ? t.maxDate : "",
            o = [];
          if (e && a)
            for (
              var r = Number(this.getSelectedYear(t, e, "left")),
                n = Number(this.getSelectedYear(t, a, "right")) - r,
                i = 0;
              i <= n;
              i++
            )
        ...
        (t.prototype.isDateAvailable = function(a, t, e, o, r, n, i, l) {
          var m = !1,
            d = l.type,
            c = l.dateArray ? l.dateArray : [],
            s = l.inputDateFormat,
            f = l.disableWeekends,
            b = l.disableWeekdays;
          return (
            "daily" == d && ((t = n < t ? t : n), (e = e < i ? e : i)),
            t <= a &&
              a <= e &&
              (m =
                !(0 < c.length) ||
                g.some(c, function(t) {
                  var e = null;
                  return isNaN(Number(a)) && (e = s || p(a)._f), p(t, e).valueOf() == a;
                })) &&
              (f && (m = !this.isWeekend(a)), b && (m = !this.isWeekday(a))),
            m
          );
        }),
        (t.prototype.isDateInRange = function(t, e, a, o, r, n, i, l, m) {
          var d = !1,
            c = m.type;
          return (
            m.singleDatePicker ||
              ("daily" == c && ((e = n), (a = i)), o <= t && t <= r && e <= t && t <= a && l && (d = !0)),
            d
          );
        }),
        (t.prototype.isDateActive = function(t, e, a, o) {
          var r = !1;
          return ((t == e && "left" == o) || (t == a && "right" == o)) && (r = !0), r;
        }),
        (t.prototype.isDateToday = function(t, e) {
          var a = !1,
            o = p()
              .startOf("day")
              .valueOf(),
            r = e.type,
            n = this.getFirstLastDay(p(o).format(x), r),
            i = p(n.firstDay, x).valueOf(),
            l = p(n.lastDay, x).valueOf();
          return i <= t && t <= l && (a = !0), a;
        }),
        (t.prototype.isWeekday = function(t, e) {
          return !this.isWeekend(t, e);
        }),
        (t.prototype.isWeekend = function(t, e) {
          e || (e = null);
          var a = p(t, e).day();
          return 0 == a || 6 == a;
        }),
        (t.prototype.getCalendarRowVariables = function(t) {
          var e = {},
            a = t.type,
            o = t.monthStartWeekNumber,
            r = t.dateRows,
            n = "" + t.year;
          return (
            "daily" == a
              ? ((e.rowNumber = o + r), (e.columns = 6))
              : "weekly" == a
              ? ((e.rowNumber = ""), (e.columns = 6))
              : "monthly" == a
              ? ((e.rowNumber = r + 1), (e.columns = 2))
              : "quarterly" == a
              ? ((e.rowNumber = n.charAt(r)), (e.columns = 0))
              : "yearly" == a && ((e.rowNumber = ""), (e.columns = 0)),
            e
          );
        }),
        (t.prototype.getCalendarRowItemVariables = function(t) {
          var e,
            a = { currentItemDate: "", rowItemText: "", itemCount: null },
            o = t.type,
            r = t.monthStartWeekNumber,
            n = t.yearStartDate,
            i = t.year,
            l = t.rowItem,
            m = t.dateRows,
            ...
            s = "";
          if ("daily" == o) {
            if (!g.isNil(r) && !g.isNil(m) && !g.isNil(i)) {
              var f = p()
                .year(i)
                .startOf("year")
                .format(x);
            ...
            "monthly" == o
              ...
              : "quarterly" == o &&
                (g.isNil(d) ||
                  ...
                  (s = "Quarter " + (d + 1))));
          return (
            (e = this.getFirstLastDay(c, o)),
            (a.itemCount = d),
            (a.currentItemDate = c),
            (a.rowItemText = s),
            (a.firstDay = e.firstDay),
            (a.lastDay = e.lastDay),
            a
          );
        }),
        (t.prototype.isRowIemValid = function(t) {
          var e = !1,
            a = t.type,
            o = t.year,
            r = t.itemCount,
            n = t.retailCalendar,
            i = this.getYearlyWeekCount(o, n);
          if ("daily" == a) e = !0;
          else if ("weekly" == a) r < i && (e = !0);
          else {
            if ("monthly" == a) return !0;
            if ("quarterly" == a) return !0;
          }
          return e;
        }),
        (t.prototype.formatStartDate = function(t, e) {
          var a = t ? t.startDate : null,
            o = t ? t.type : "",
            r = null;
          return (
            a &&
        ...
        (t.prototype.getSelectedYear = function(t, e, a) {
          return p(e, x).format("YYYY");
        }),
        (t.prototype.getFirstLastDay = function(t, e) {
          var a = "",
            o = "";
          return (
            "daily" == e
              ...
              : "yearly" == e &&
                ...
                (o = p(t, x)
                  .endOf("year")
                  .format(x))),
            { firstDay: a, lastDay: o }
          );
        }),
        (t.prototype.getLocalTimezone = function() {
          var t = /\((.*)\)/.exec(new Date().toString())[1];
          return (t = "Central Europe Standard Time" == t ? L : R);
        }),
        (t.prototype.getZoneDate = function(t, e, a) {
          a = a
            ? p(a, e)
                .startOf("day")
                .valueOf()
            : p().valueOf();
          var o = new Date(a).toLocaleString("en-US", { timeZone: A[t] });
          return (o = p(o, "MM/DD/YYYY, hh:mm:ss A"));
        }),
        (t.prototype.getZoneToday = function(t, e) {
          var a = this.getZoneDate(t, e);
          return p(a).format(e + "  hh:mm A");
        }),
        (t.prototype.formatToZoneDate = function(t, e, a) {
          var o = this.getZoneDate(t, e, a);
          return p(o).format("" + e);
        }),
        (t.prototype.convertToViewTimeItem = function(t) {
          var e = t + "";
          return 1 == e.length && (e = "0" + e), e;
        }),
        (t.prototype.getWeekNumber = function(t) {
          if (t) {
            var e = p(t, "YYYY-MM-DD").year(),
              a = p(t, "YYYY-MM-DD").month(),
              o = Number(p(t, "YYYY-MM-DD").format("D")),
              r = new Date(e, 0, 1),
              n = new Date(e, a, o);
            return Math.ceil(((n.getTime() - r.getTime()) / 864e5 + r.getDay() + 1) / 7);
          }
          return console.warn("getWeekNumber: Invalid date"), this.getNotAvailableText();
        }),
        (t.decorators = [{ type: n.Injectable }]),
        t
      );
    })(),
    S = require("moment"),
    H = require("lodash"),
    C = { focus: 1, blur: 2 };
  (C[C.focus] = "focus"), (C[C.blur] = "blur");
  var F = b.DEFAULT.DATE_FROMAT,
    I = b.DEFAULT.TIME_FORMAT,
    Y = b.DEFAULT.START_DATE,
    E = b.DEFAULT.END_DATE,
    P = b.DEFAULT.MIN_DATE,
    j = b.DEFAULT.MAX_DATE,
    q = b.DEFAULT.START_TIME,
    U = b.DEFAULT.END_TIME,
    _ = b.CONSTANT.TZ_CODES,
    B = b.CONSTANT.USA_TZ_CODE,
    G = (function() {
      function t(t, e, a) {
        var o = this;
        (this.element = t),
          (this.renderer = e),
          (this.dateTimeRangePickerUtilityService = a),
          (this.canBeEmpty = !1),
          (this.dateRangeModelChange = new n.EventEmitter()),
          (this.dateRangeChanged = new n.EventEmitter()),
          (this.inputFocusBlur = new n.EventEmitter()),
          (this.selectedDate = new n.EventEmitter()),
          (this.sides = []),
          (this.dates = { left: {}, right: {} }),
          (this.calendarAvailable = { left: !1, right: !1 }),
          (this.showCalendar = !1),
          (this.customRange = !1),
          (this.selectedDateText = ""),
          (this.dateTitleText = { left: "", right: "" }),
          (this.weekDayOptions = ["su", "mo", "tu", "we", "th", "fr", "sa"]),
          (this.selectedMonth = { left: "", right: "" }),
          (this.selectedYear = { left: "", right: "" }),
          (this.activeItem = { left: "", right: "" }),
          (this.activeStartDate = null),
          (this.activeEndDate = null),
          (this.activeRange = null),
          (this.frequencyColumnHeader = null),
          (this.config = {}),
          (this.isValidFilter = !1),
          (this.isUserModelChange = !0),
          (this.timezones = _),
          (this.localTimezone = this.dateTimeRangePickerUtilityService.getLocalTimezone()),
          (this.todayTime = ""),
          (this.timeItems = ["hour", "minute"]),
          (this.times = { left: "", right: "" }),
          (this.selectedHour = { left: "", right: "" }),
          (this.selectedMinute = { left: "", right: "" }),
          (this.selectedMeridian = { left: "", right: "" }),
          ...
          this.renderer.listenGlobal("document", "click", function(t) {
            o.showCalendar &&
              t.target &&
              "mat-option-text" != t.target.className &&
              o.element.nativeElement !== t.target &&
              !o.element.nativeElement.contains(t.target) &&
              o.onCalendarClose(t);
          });
      }
      return (
        (t.prototype.ngOnChanges = function(t) {
          ...
          if (
            ((this.isUserModelChange = !0),
            t.canBeEmpty && (this.canBeEmpty = t.canBeEmpty.currentValue),
            t.settings && (this.settings = H.merge(this.settings, t.settings.currentValue)),
            t.dateRangeModel && (this.dateRangeModel = t.dateRangeModel.currentValue),
            t.dateRangeModel && !t.dateRangeModel.firstChange)
          ) {
            var a = t.dateRangeModel.previousValue[this.config.selectedModel],
              o = t.dateRangeModel.currentValue[this.config.selectedModel];
            a && o && a.startDate == o.startDate && a.endDate == o.endDate && (this.isUserModelChange = !1);
          }
          t.optionService &&
            t.optionService.currentValue &&
            t.optionService.currentValue.subscribe(
              function(t) {
                H.isObject(t) && !H.isArray(t) && (e.options = t.plain ? t.plain() : t);
              },
              function(t) {
                console.error("DateRangePickerComponent | Filter Call Failure: ", t);
              },
              function() {
                e.init();
              }
            ),
            t.options && (this.options = t.options ? t.options.currentValue : this.options),
            t.optionService || this.init();
        }),
        (t.prototype.onDateRangeInputChange = function(t) {
          this.dateRangeSelected();
        }),
        (t.prototype.setDisabledState = function(t) {
          this.config.componentDisabled = t;
        }),
        (t.prototype.onComponentClick = function() {
          this.showCalendar = !this.showCalendar;
        }),
        (t.prototype.onFocusInput = function(t) {
          this.inputFocusBlur.emit({ reason: C.focus, value: t.target.value });
        }),
        (t.prototype.onBlurInput = function(t) {
          (this.selectedDateText = t.target.value), this.inputFocusBlur.emit({ reason: C.blur, value: t.target.value });
        }),
        (t.prototype.onCalendarClose = function(t) {
          this.config.startDate &&
            this.config.endDate &&
            (this.filterInputBox.nativeElement.classList.remove("empty-filter"), (this.showCalendar = !1));
        }),
        (t.prototype.isPrevAvailale = function(t) {
          var e = this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(this.config.minDate, F);
          return (
            S(t, "MMM YYYY")
              .startOf("month")
              .valueOf() >
        ...
        (t.prototype.isNextAvailale = function(t) {
          var e = this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(this.config.maxDate, F);
          return (
            S(t, "MMM YYYY")
              .endOf("month")
              .valueOf() <
        ...
        (t.prototype.getCalendarColspan = function() {
          return "daily" == this.config.type
            ? 6
            : "weekly" == this.config.type
            ? 8
            : "monthly" == this.config.type
            ? 3
            : "quarterly" == this.config.type
            ? 1
            : "yearly" == this.config.type
            ? 1
            : void 0;
        }),
        (t.prototype.getCalendarRowItemColspan = function() {
          return "monthly" == this.config.type
            ? 3
            : "quarterly" == this.config.type
            ? 6
            : "yearly" == this.config.type
        ...
        (t.prototype.getDatecharacteristics = function(t, e, a) {
          var o = S(t, F)
              .startOf("day")
              .valueOf(),
            r = S(this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(this.config.minDate, F), F)
              .startOf("day")
              .valueOf(),
            n = S(this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(this.config.maxDate, F), F)
              .startOf("day")
              .valueOf(),
            i = S(this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(this.config.startDate, F), F)
              .startOf("day")
              .valueOf(),
            l = S(this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(this.config.endDate, F), F)
              .startOf("day")
              .valueOf(),
            m = S(e, "MMM YYYY")
              .startOf("month")
            ...
            d = S(e, "MMM YYYY")
              ...
              .startOf("day")
              .valueOf(),
            c = this.dateTimeRangePickerUtilityService.isDateAvailable(o, r, n, i, l, m, d, this.config),
            s = this.dateTimeRangePickerUtilityService.isDateInRange(o, r, n, i, l, m, d, c, this.config),
            f = this.dateTimeRangePickerUtilityService.isDateActive(o, i, l, a),
            b = this.dateTimeRangePickerUtilityService.isDateToday(o, this.config);
          return (
            o == i && "left" == a ? (this.activeStartDate = t) : o == l && "right" == a && (this.activeEndDate = t),
            { available: c, inRange: s, active: f, today: b }
          );
        }),
        (t.prototype.onClickPrevious = function(t, e) {
          var a = S(t, "MMM YYYY")
            .subtract(1, "month")
            .startOf("month")
            .format(F);
          this.dates[e] = this.generateCalendar(a, e);
        }),
        (t.prototype.onClickNext = function(t, e) {
          var a = S(t, "MMM YYYY")
            .add(1, "month")
            .endOf("month")
            .format(F);
        ...
        (t.prototype.onCellClick = function(t, e, a) {
          var o = t.date ? S(t.date, F).valueOf() : t.date,
            r = this.config.startDate ? S(this.config.startDate, F).valueOf() : this.config.startDate,
            n = this.config.endDate ? S(this.config.endDate, F).valueOf() : this.config.endDate,
            i = this.config.minDate ? S(this.config.minDate, F).valueOf() : this.config.minDate,
            l = this.config.maxDate ? S(this.config.maxDate, F).valueOf() : this.config.maxDate;
          if (!t.available) {
            if (o < i || l < o) return;
            this.dates[a] = this.generateCalendar(t.date, a);
          }
          n || o < r
            ? ((this.config.endDate = null), (this.config.startDate = t.date), (this.activeItem.left = t))
            : (this.activeItem.right = ((this.config.endDate =
                !n && o < r ? H.cloneDeep(this.config.startDate) : t.date),
              t)),
            this.config.singleDatePicker &&
              ((this.config.endDate = H.cloneDeep(this.config.startDate)),
              (this.activeItem.right = this.activeItem.left = t)),
            this.doApply();
        }),
        (t.prototype.onCellMouseEnter = function(t, e) {
          var a = this;
          if (t.available) {
            var o = t.date ? S(t.date, F).valueOf() : t.date,
              r = this.config.startDate ? S(this.config.startDate, F).valueOf() : this.config.startDate,
              n = this.config.endDate ? S(this.config.endDate, F).valueOf() : this.config.endDate,
              i = e ? e.getAttribute("firstDay") : "",
              l = e ? e.getAttribute("lastDay") : "",
              m =
                (e ? e.innerText : "") +
                " (" +
                (i = S(i, F).format(this.config.viewDateFormat)) +
                " - " +
                (l = S(l, F).format(this.config.viewDateFormat)) +
                ")";
            "daily" == this.config.type && (m = "" + l),
              n
                ? this.config.singleDatePicker
                  ? (this.dateTitleText.right = m)
                  : (this.dateTitleText.left = m)
                : H.forOwn(this.dates, function(t, e) {
                    H.forEach(t.itemRows, function(t) {
                      H.forEach(t.items, function(t) {
                        if (t.available) {
                          var e = t.date ? S(t.date, F).valueOf() : t.date;
                          ((r < e && e < o) || o == e) && ((t.inRange = !0), (a.dateTitleText.right = m));
                        }
                      });
                    });
                  });
        ...
        (t.prototype.onCellMouseLeave = function() {
          this.config.endDate
        ...
        (t.prototype.onRangeClick = function(t, e) {
          "Custom Range" == (this.activeRange = t)
            ? ((this.customRange = !this.customRange),
              this.customRange
                ? this.updateCalendar()
                : ((this.sides.length = 0), (this.dates = {}), this.config.timePicker && (this.times = {})))
            : ((this.config.startDate = e.startDate),
              (this.config.endDate = e.endDate),
              this.config.timePicker && (this.config.timePicker && (this.times = {}), this.updateCalendar()),
              this.setActiveItemOnRangeClick());
        }),
        (t.prototype.updateCalendar = function() {
          (this.sides.length = 0),
            (this.dates = {}),
            this.config.singleDatePicker ||
              (this.sides.push("left"),
              (this.dates.left = this.generateCalendar(this.config.startDate, "left")),
              this.config.timePicker && (this.times.left = this.generateTimePicker(this.config.startTime, "left"))),
            this.sides.push("right"),
            (this.dates.right = this.generateCalendar(this.config.endDate, "right")),
            this.config.timePicker && (this.times.right = this.generateTimePicker(this.config.endTime, "right"));
        }),
        (t.prototype.onCalendarLabelChange = function(t, e, a) {
          if (
            ((this.showCalendar = !0),
            "month" == a ? (this.selectedMonth[e] = t) : "year" == a && (this.selectedYear[e] = t),
            "daily" != this.config.type && (this.selectedMonth[e] = "Jun"),
            "yearly" != this.config.type)
          ) {
            var o = this.selectedMonth[e] + " " + this.selectedYear[e],
              r = S(o, "MMM YYYY")
                .startOf("month")
                .format(F);
            this.dates[e] = this.generateCalendar(r, e);
          } else {
            this.selectedYear.left <= this.selectedYear.right &&
              "right" == e &&
              ((this.config.startDate = S(this.selectedYear.left, "YYYY")
                .startOf("year")
                .format(F)),
              (this.config.endDate = S(this.selectedYear.right, "YYYY")
                .endOf("year")
                .format(F)),
              this.doApply());
            var n = {
                startDate: S(this.selectedYear.left, "YYYY")
                  .startOf("year")
                  .format(F),
                type: "yearly"
              },
              i = this.dateTimeRangePickerUtilityService.formatStartDate(n, this.config.viewDateFormat),
              l = this.config.endDate ? S(this.config.endDate, F).format(this.config.viewDateFormat) : "";
            (this.dateTitleText.left = "" + i), (this.dateTitleText.right = "" + l);
          }
        }),
        (t.prototype.onTimeLabelChange = function(t, e, a) {
          var o = null;
          "left" == e
            ? ((o = this.config.startTime.split(":")),
              (this.config.startTime = "hour" == t ? a + ":" + o[1] : o[0] + ":" + a),
              S(this.config.startDate, F).valueOf() == S(this.config.endDate, F).valueOf() &&
                (this.times.right = this.generateTimePicker(this.config.startTime, "right")))
            : ((o = this.config.endTime.split(":")),
              (this.config.endTime = "hour" == t ? a + ":" + o[1] : o[0] + ":" + a));
          "hour" == t
            ? (this.selectedHour[e] = this.dateTimeRangePickerUtilityService.convertToViewTimeItem(a))
            : (this.selectedMinute[e] = this.dateTimeRangePickerUtilityService.convertToViewTimeItem(a));
        }),
        (t.prototype.onTimeApply = function() {
          this.dateRangeSelected(), this.updateInputField();
        }),
        (t.prototype.init = function() {
          this.isUserModelChange &&
            ((this.isValidFilter = !1),
        ...
        (t.prototype.parseOptions = function() {
          ...
          this.options !== undefined &&
            Object.keys(this.options).forEach(function(t) {
              e.config[t] = e.options[t];
            }),
            this.settings !== undefined &&
              Object.keys(this.settings).forEach(function(t) {
                e.config[t] = e.settings[t];
              }),
            (this.config.selectedModel = this.config.selectedModel ? this.config.selectedModel : this.config.type),
            ("weekly" != this.config.type && "yearly" != this.config.type) || (this.config.showRowNumber = !1),
            this.config.singleDatePicker && (this.config.startDate = H.cloneDeep(this.config.endDate)),
            this.selectTimeZone(),
        ...
        (t.prototype.selectTimeZone = function() {
          this.config.timezoneSupport &&
            (this.config.defaultTimezone || (this.config.defaultTimezone = B),
        ...
        (t.prototype.parseOptionsToDefaultDateFormat = function() {
        ...
        (t.prototype.processDateRangeModel = function() {
          if (
            undefined != this.dateRangeModel &&
            !H.isEmpty(this.dateRangeModel) &&
            this.dateRangeModel[this.config.selectedModel]
          ) {
            var t = this.dateRangeModel[this.config.selectedModel].minDate,
              e = this.dateRangeModel[this.config.selectedModel].maxDate,
              a = this.dateRangeModel[this.config.selectedModel].startDate,
              o = this.dateRangeModel[this.config.selectedModel].endDate,
              r = this.dateRangeModel[this.config.selectedModel].dateArray;
            if (
              ((this.config.dateArray = r || this.config.dateArray),
              (this.config.minDate = t
                ? this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(t, this.config.inputDateFormat)
                : this.config.minDate),
              (this.config.maxDate = e
                ? this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(e, this.config.inputDateFormat)
                : this.config.maxDate),
              (this.config.startDate = a
                ? this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(a, this.config.inputDateFormat)
                : this.config.startDate),
              (this.config.endDate = o
                ? this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(o, this.config.inputDateFormat)
                : this.config.endDate),
              this.config.timePicker)
            ) {
              var n = this.dateRangeModel[this.config.selectedModel].minTime,
                i = this.dateRangeModel[this.config.selectedModel].maxTime,
                l = this.dateRangeModel[this.config.selectedModel].startTime,
                m = this.dateRangeModel[this.config.selectedModel].endTime;
              (this.config.minTime = this.config.minTime
                ? this.dateTimeRangePickerUtilityService.formatTimeToDefaultFormat(n)
                : this.config.minTime),
                (this.config.maxTime = this.config.maxTime
                  ? this.dateTimeRangePickerUtilityService.formatTimeToDefaultFormat(i)
                  : this.config.maxTime),
                (this.config.startTime = this.config.startTime
                  ? this.dateTimeRangePickerUtilityService.formatTimeToDefaultFormat(l)
                  : this.config.startTime),
                (this.config.endTime = this.config.endTime
                  ? this.dateTimeRangePickerUtilityService.formatTimeToDefaultFormat(m)
                  : this.config.endTime);
            }
          }
        }),
        (t.prototype.handleDateArray = function() {
          var o = this;
          if (this.config.dateArray && 0 < this.config.dateArray.length) {
            (this.config.dateArray = this.dateTimeRangePickerUtilityService.getSanitizedDateArray(this.config)),
              (this.config.dateArray = H.sortBy(this.config.dateArray, function(t) {
                var e = null;
                isNaN(Number(t)) && (e = o.config.inputDateFormat ? o.config.inputDateFormat : S(t)._f);
                var a = S(t, e).valueOf();
                if (!isNaN(a)) return a;
                console.warn(
                  "M1 Date Range Picker: Values in Date Array are not in any known format. Please pass the format or pass the dates in any known format"
            ...
            var t = this.config.dateArray[0],
              e = this.config.dateArray[this.config.dateArray.length - 1];
            S(this.config.minDate, F).valueOf() == S(P, F).valueOf() &&
              (this.config.minDate = this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(
                t,
                this.config.inputDateFormat
              )),
              S(this.config.maxDate, F).valueOf() == S(j, F).valueOf() &&
                (this.config.maxDate = this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(
                  e,
                  this.config.inputDateFormat
                )),
              S(this.config.startDate, F).valueOf() == S(Y, F).valueOf() &&
                (this.config.startDate = this.dateTimeRangePickerUtilityService.formatDateToDefaultFormat(
                  t,
                  this.config.inputDateFormat
                )),
              S(this.config.endDate, F).valueOf() == S(E, F).valueOf() &&
        ...
        (t.prototype.sanitizeDates = function() {
          if (
            ("monthly" == this.config.type
              ? ((this.config.minDate = S(this.config.minDate, F)
                  .endOf("month")
                  .format(F)),
                (this.config.maxDate = S(this.config.maxDate, F)
                  .subtract(0, "week")
                  .endOf("month")
                  .format(F)),
                (this.config.startDate = S(this.config.startDate, F)
                  .endOf("month")
                  .format(F)),
                (this.config.endDate = S(this.config.endDate, F)
                  .subtract(0, "week")
                  .endOf("month")
                  .format(F)))
              : "quarterly" == this.config.type &&
            ...
            var t = S(this.config.minDate, F).format(F),
              e = S(this.config.startDate, F).format(F);
            (this.config.minDate = t), (this.config.startDate = e);
          }
          S(this.config.startDate, F).valueOf() < S(this.config.minDate, F).valueOf() &&
            (this.config.minDate = this.config.startDate),
            S(this.config.endDate, F).valueOf() > S(this.config.maxDate, F).valueOf() &&
              (this.config.maxDate = this.config.endDate);
        }),
        (t.prototype.processRanges = function() {
          this.config.showRanges && !this.config.singleDatePicker
            ? (H.isEmpty(this.config.availableRanges) &&
                (this.config.availableRanges = this.dateTimeRangePickerUtilityService.createDefaultRanges(this.config)),
              this.selectActiveRange())
            : ((this.activeRange = "Custom Range"), this.onRangeClick(this.activeRange, null));
        }),
        (t.prototype.selectActiveRange = function() {
          var a = this;
          H.forOwn(this.config.availableRanges, function(t, e) {
            a.config.startDate == t.startDate &&
              a.config.endDate == t.endDate &&
              ((a.activeRange = e), a.updateActiveItem());
          }),
            this.activeRange || ((this.activeRange = "Custom Range"), this.onRangeClick(this.activeRange, null));
        }),
        (t.prototype.generateCalendar = function(t, e) {
          (this.selectedMonth[e] = S(t, F).format("MMM")),
            (this.selectedYear[e] = this.dateTimeRangePickerUtilityService.getSelectedYear(this.config, t, e));
          var a = this.selectedMonth[e] + " " + this.selectedYear[e],
            o = {
              label: a,
          ...
          if (((this.weekDayOptions = [""]), "yearly" != this.config.type)) {
            var r = S(t, F)
                .year(this.selectedYear[e])
                .startOf("month")
                .week(),
              n = S(this.selectedYear[e], "YYYY")
                .startOf("year")
                .format(F),
              i = 1,
              l = 0,
              ...
              p = "",
              g = "";
            "daily" == this.config.type
              ? ((i = this.dateTimeRangePickerUtilityService.getNumberOfWeeks(t)),
                (this.weekDayOptions = ["su", "mo", "tu", "we", "th", "fr", "sa"]))
              : "weekly" == this.config.type
              ? ((i = 8), (this.weekDayOptions = ["", "", "", "", "", "", ""]))
              : "monthly" == this.config.type
              ? ((i = 4), (this.weekDayOptions = ["", "", ""]))
              : "quarterly" == this.config.type && ((i = 4), (this.weekDayOptions = [""]));
            for (var u = 0; u < i; u++) {
              var h = { rowNumber: null, rowNumberText: null, items: [] },
                x = {};
              (x.type = this.config.type),
                (x.monthStartWeekNumber = r),
                (x.dateRows = u),
                (x.year = this.selectedYear[e]),
                (l = (f = this.dateTimeRangePickerUtilityService.getCalendarRowVariables(x)).rowNumber),
                (m = f.columns),
                (h.rowNumber = l),
                (h.rowNumberText = this.dateTimeRangePickerUtilityService.getCalendarRowNumberText(
                  this.config.type,
                  l
                ));
              for (var v = 0; v <= m; v++) {
                var k = {};
                (k.type = this.config.type),
                  (k.monthStartWeekNumber = r),
                  (k.dateRows = u),
                  (k.rowNumber = l),
                  (k.yearStartDate = n),
                  (k.year = this.selectedYear[e]),
                  (k.rowItem = v),
                  (k.columns = m),
                  (k.year = this.selectedYear[e]),
                  (d = (b = this.dateTimeRangePickerUtilityService.getCalendarRowItemVariables(k)).currentItemDate),
                  (s = b.rowItemText),
                  (p = b.firstDay),
                  (g = b.lastDay),
                ...
                var w = {
                  ...
                  firstDay: p,
                  lastDay: g,
                  available: (c = this.getDatecharacteristics(d, a, e)).available,
                  inRange: c.inRange,
                  active: c.active,
                  today: c.today
                };
                this.dateTimeRangePickerUtilityService.isRowIemValid(x) &&
                  (c.active && (this.activeItem[e] = w), h.items.push(w));
              }
              o.itemRows.push(h);
            }
          }
          return (this.calendarAvailable[e] = !0), o;
        }),
        (t.prototype.generateTimePicker = function(t, e) {
          var a = { hour: [], minute: [], meridian: [] },
            o = 0,
            r = 0,
            n = "left" == e ? o : 23,
            i = "left" == e ? r : 59,
            l = S(this.config.startDate, F).valueOf(),
            m = S(this.config.endDate, F).valueOf();
          t && ((n = S(t, I).format("H")), (i = S(t, I).format("m")), "right" == e && l == m && ((o = n), (r = i)));
          for (var d = o; d <= 23; d++) {
            var c = this.dateTimeRangePickerUtilityService.convertToViewTimeItem(d);
            a.hour.push(c);
          }
          for (var s = r; s <= 59; s++) {
            var f = this.dateTimeRangePickerUtilityService.convertToViewTimeItem(s);
            a.minute.push(f);
          }
          return (
            (this.selectedHour[e] = this.dateTimeRangePickerUtilityService.convertToViewTimeItem(n)),
            (this.selectedMinute[e] = this.dateTimeRangePickerUtilityService.convertToViewTimeItem(i)),
            "left" == e
              ? (this.config.startTime = this.selectedHour[e] + ":" + this.selectedMinute[e])
              : "right" == e && (this.config.endTime = this.selectedHour[e] + ":" + this.selectedMinute[e]),
            a
          );
        }),
        (t.prototype.capitalize = function(t) {
          return H.capitalize(t);
        }),
        (t.prototype.updateInputField = function() {
          var t = this.dateTimeRangePickerUtilityService.formatStartDate(this.config, this.config.viewDateFormat),
            e = this.config.endDate ? S(this.config.endDate, F).format(this.config.viewDateFormat) : "";
          if (this.config.singleDatePicker) {
            var a = t,
              o = e,
              r = "";
            this.config.timePicker && ((a = t + " " + this.config.startTime), (o = e + " " + this.config.endTime)),
              (r = this.config.displayBeginDate ? "" + a : this.config.displayEndDate ? "" + o : a + " - " + o),
              (this.selectedDateText = r);
          } else {
            (a = t), (o = e);
            this.config.timePicker && ((a = t + " " + this.config.startTime), (o = e + " " + this.config.endTime)),
              (this.selectedDateText = a + " - " + o);
          }
          (this.canBeEmpty || this.selectedDateText.indexOf("nvalid") < 0) && (this.isValidFilter = !0),
            "yearly" == this.config.type
              ? ((this.dateTitleText.left = "" + t), (this.dateTitleText.right = "" + e))
              : this.updateActiveItemInputField();
        }),
        (t.prototype.updateActiveItemInputField = function() {
          var t = "",
            e = "",
            a = "";
          this.config.singleDatePicker ||
            ((t = this.activeItem.left.firstDay),
            (e = this.activeItem.left.lastDay),
            (a = this.activeItem.left.rowItemText),
            (t = S(t, F).format(this.config.viewDateFormat)),
            (e = S(e, F).format(this.config.viewDateFormat)),
            "daily" != this.config.type
              ? (this.dateTitleText.left = a + " (" + t + " - " + e + ")")
              : (this.dateTitleText.left = "" + t)),
            (t = this.activeItem.right.firstDay),
            (e = this.activeItem.right.lastDay),
            (a = this.activeItem.right.rowItemText),
            (t = S(t, F).format(this.config.viewDateFormat)),
            (e = S(e, F).format(this.config.viewDateFormat)),
            "daily" != this.config.type
              ? (this.dateTitleText.right = a + " (" + t + " - " + e + ")")
              : (this.dateTitleText.right = "" + t);
        }),
        (t.prototype.dateRangeSelected = function() {
          var t = this.getDateRangeModelItem();
          (this.showCalendar = !1),
            this.filterInputBox.nativeElement.classList.remove("empty-filter"),
            this.doDateRangeModelChange(),
            this.dateRangeChanged.emit(t);
        }),
        (t.prototype.getDateRangeModel = function(t) {
          var e = {};
          return (
            undefined == this.dateRangeModel ||
              H.isEmpty(this.dateRangeModel) ||
              (e = H.cloneDeep(this.dateRangeModel)),
            (e[this.config.selectedModel] = this.getDateRangeModelItem(t)),
            e
          );
        }),
        (t.prototype.getDateRangeModelItem = function(t) {
          var e,
            a = this.config.outputDateFormat;
          undefined != t && (a = t);
          var o = this.dateTimeRangePickerUtilityService.formatStartDate(this.config, a),
            r = S(this.config.endDate, F).format(a);
          (this.config.selectedTimezone &&
            ((o = this.dateTimeRangePickerUtilityService.formatToZoneDate(this.config.selectedTimezone, a, o)),
            (r = this.dateTimeRangePickerUtilityService.formatToZoneDate(this.config.selectedTimezone, a, r))),
          (e = { startDate: o, endDate: r }),
          this.config.timePicker) &&
            (e = { startDate: o, endDate: r, startTime: this.config.startTime, endTime: this.config.endTime });
          return e;
        }),
        (t.prototype.doApply = function() {
          var e = this,
            t = this.config.startDate,
            a = this.config.endDate;
          (this.activeStartDate = t),
            (this.activeEndDate = a),
            this.config.startDate &&
              this.config.endDate &&
              (this.config.timePicker
                ? this.config.timePicker &&
                  H.forEach(this.sides, function(t) {
                    e.times[t] = e.generateTimePicker(null, t);
                  })
                : this.dateRangeSelected());
          var o = t ? S(t, F).valueOf() : null,
            r = a ? S(a, F).valueOf() : null;
          this.config.outputDateFormat &&
            ((o = t ? S(t, F).format(this.config.outputDateFormat) : null),
            (r = a ? S(a, F).format(this.config.outputDateFormat) : null)),
            this.selectedDate.emit({ startDate: o, endDate: r }),
            this.updateInputField();
        }),
        (t.prototype.doDateRangeModelChange = function() {
          var t = this.getDateRangeModel(this.config.inputDateFormat);
          this.dateRangeModelChange.emit(t);
        }),
        (t.prototype.onTimezoneChange = function(t) {
          var o = this;
          (this.selectedTimezone = t),
            (this.todayTime = this.dateTimeRangePickerUtilityService.getZoneToday(
              this.selectedTimezone,
              this.config.viewDateFormat
            )),
            this.parseOptionsToDefaultDateFormat(),
            H.forEach(this.sides, function(t) {
              var e = o.config.startDate,
                a = o.config.startTime;
              "right" == t && ((e = o.config.endDate), (a = o.config.endTime)),
                (o.dates[t] = o.generateCalendar(e, t)),
                o.config.timePicker && (o.times[t] = o.generateTimePicker(a, t));
            });
        }),
        (t.prototype.getSelectedTimeItemText = function(t, e) {
          return "hour" == t ? this.selectedHour[e] : "minute" == t ? this.selectedMinute[e] : void 0;
        }),
        (t.prototype.setActiveItemOnRangeClick = function() {
          this.updateActiveItem(), this.doApply();
        }),
        (t.prototype.updateActiveItem = function() {
          var t = this.dateTimeRangePickerUtilityService.getFirstLastDay(this.config.startDate, this.config.type),
            e = this.dateTimeRangePickerUtilityService.getFirstLastDay(this.config.endDate, this.config.type);
          "weekly" == this.config.type
            ? ((t.rowItemText = "W" + this.dateTimeRangePickerUtilityService.getWeekNumber(t.firstDay)),
              (e.rowItemText = "W" + this.dateTimeRangePickerUtilityService.getWeekNumber(e.firstDay)))
            : "monthly" == this.config.type
            ? ((t.rowItemText = "" + S(t.firstDay, F).format("MMM")),
              (e.rowItemText = "" + S(e.firstDay, F).format("MMM")))
            : "quarterly" == this.config.type &&
              ((t.rowItemText = "Quarter " + S(t.firstDay, F).quarter()),
              (e.rowItemText = "Quarter " + S(e.firstDay, F).quarter())),
            (this.activeItem.left = t),
            (this.activeItem.right = e);
        }),
        (t.decorators = [
          {
            type: n.Component,
        ...
        (t.ctorParameters = function() {
          return [{ type: n.ElementRef }, { type: n.Renderer }, { type: O }];
        }),
        (t.propDecorators = {
          options: [{ type: n.Input }],
          settings: [{ type: n.Input }],
          optionService: [{ type: n.Input }],
          dateRangeModel: [{ type: n.Input }],
          canBeEmpty: [{ type: n.Input }],
          dateRangeModelChange: [{ type: n.Output }],
          dateRangeChanged: [{ type: n.Output }],
          inputFocusBlur: [{ type: n.Output }],
          selectedDate: [{ type: n.Output }],
          filterInputBox: [{ type: n.ViewChild, args: ["filterInputBox"] }]
        }),
        t
      );
    })(),
  ...
  (t.NgxDateTimeRangePickerModule = V), Object.defineProperty(t, "__esModule", { value: !0 });
});
