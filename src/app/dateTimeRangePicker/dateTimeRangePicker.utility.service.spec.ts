...
describe("DateTimeRangePickerUtilityService", () => {
    ...
    it("#formatDateToDefaultFormat", () => {
        expect(service.formatDateToDefaultFormat("2017-02-02")).toEqual(
            "2017-02-02",
        );
        ...
        expect(
            service.formatDateToDefaultFormat("2017/02/02", "YYYY/MM/DD"),
        ).toEqual("2017-02-02");
    });
    ...
    it("#getMonthsAvailable", () => {
        ...
        expect(
            service.getMonthsAvailable(minDate, maxDate, selectedYear),
        ).toEqual(["Jan", "Feb", "Mar"]);
    ...
    it("#isDateActive", () => {
        ...
        const endDate = "2017-03-01";
        expect(
            service.isDateActive(date, startDate, endDate, side),
        ).toBeTruthy();
    });
    ...
    it("#getFirstLastDay", () => {
        ...
        _.forEach(typeArray, (type) => {
            expect(Object.keys(service.getFirstLastDay(date, type))).toEqual([
                "firstDay",
                "lastDay",
            ]);
        });
