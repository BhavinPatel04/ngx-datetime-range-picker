...
/** @type {?} */
const DateRangePickerConstants = {
  DEFAULT: {
    TYPE: "daily",
    INPUT_CLASS: "m1drp",
...
/** @type {?} */
const EU_TZ_CODE$1 = DateRangePickerConstants.CONSTANT.EU_TZ_CODE;
/** @type {?} */
const TZ_NAMES = DateRangePickerConstants.CONSTANT.TZ_NAMES;
class DateTimeRangePickerUtilityService {
  /**
   * @return {?}
   */
  getNotAvailableText() {
...
/** @type {?} */
const DEFAULT_DATE_FROMAT$1 = DateRangePickerConstants.DEFAULT.DATE_FROMAT;
/** @type {?} */
const DEFAULT_TIME_FORMAT$1 = DateRangePickerConstants.DEFAULT.TIME_FORMAT;
/** @type {?} */
const DEFAULT_START_DATE$1 = DateRangePickerConstants.DEFAULT.START_DATE;
/** @type {?} */
const DEFAULT_END_DATE$1 = DateRangePickerConstants.DEFAULT.END_DATE;
/** @type {?} */
const DEFAULT_MIN_DATE$1 = DateRangePickerConstants.DEFAULT.MIN_DATE;
/** @type {?} */
const DEFAULT_MAX_DATE$1 = DateRangePickerConstants.DEFAULT.MAX_DATE;
/** @type {?} */
const DEFAULT_START_TIME$1 = DateRangePickerConstants.DEFAULT.START_TIME;
/** @type {?} */
const DEFAULT_END_TIME$1 = DateRangePickerConstants.DEFAULT.END_TIME;
/** @type {?} */
const TZ_CODES = DateRangePickerConstants.CONSTANT.TZ_CODES;
/** @type {?} */
const USA_TZ_CODE$1 = DateRangePickerConstants.CONSTANT.USA_TZ_CODE;
class DateTimeRangePickerComponent {
  /**
   * @param {?} element
   * @param {?} renderer
   * @param {?} dateTimeRangePickerUtilityService
   */
  constructor(element, renderer, dateTimeRangePickerUtilityService) {
  ...
  getDatecharacteristics(date, month, side) {
    ...
    const currentMonthEndDate = moment$2(month, "MMM YYYY")
      ...
      .valueOf();
    /** @type {?} */
    const available = this.dateTimeRangePickerUtilityService.isDateAvailable(
      currentDate,
      minDate,
      maxDate,
      startDate,
    ...
    /** @type {?} */
    const inRange = this.dateTimeRangePickerUtilityService.isDateInRange(
      currentDate,
      minDate,
      maxDate,
      startDate,
    ...
    /** @type {?} */
    const active = this.dateTimeRangePickerUtilityService.isDateActive(currentDate, startDate, endDate, side);
    /** @type {?} */
    const today = this.dateTimeRangePickerUtilityService.isDateToday(currentDate, this.config);
    // Active
      ...
      _$1.forOwn(this.dates, (sideDates, side) => {
        _$1.forEach(sideDates.itemRows, (rows) => {
          _$1.forEach(rows.items, (item) => {
            if (item.available) {
              /** @type {?} */
              const hoverItemDate = item.date ? moment$2(item.date, DEFAULT_DATE_FROMAT$1).valueOf() : item.date;
  ...
  dateRangeSelected() {
    /** @type {?} */
    const dateRangeModel = this.getDateRangeModelItem();
    this.showCalendar = false;
    this.filterInputBox.nativeElement.classList.remove("empty-filter");
    this.doDateRangeModelChange();
  ...
  updateActiveItem() {
    /** @type {?} */
    const startDate = this.dateTimeRangePickerUtilityService.getFirstLastDay(this.config.startDate, this.config.type);
    /** @type {?} */
    const endDate = this.dateTimeRangePickerUtilityService.getFirstLastDay(this.config.endDate, this.config.type);
    if (this.config.type == "weekly") {
...
/** @nocollapse */
DateTimeRangePickerComponent.ctorParameters = () => [
  { type: ElementRef },
  { type: Renderer },
  { type: DateTimeRangePickerUtilityService }
];
DateTimeRangePickerComponent.propDecorators = {
  ...
  filterInputBox: [{ type: ViewChild, args: ["filterInputBox"] }]
};
